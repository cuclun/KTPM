        ...
        <div block-bind="content" id="content">
                    ...
                    <div class="row mt-1">
                        <div class="col-12 donvi_khaibao">
                            <div class="form-group">
                                ...
                                <input type="text" name="NoiKhaiBao" class="form-control" placeholder="VD: 4, Nguyễn Văn Bảo, Phường 7, Gò Vấp " require>
                            </div>
                        </div>
                        <!-- <div class="col-12">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="tiensubenh" class="form-control" placeholder="nhập lịch sử bệnh nền(viêm phổi, viêm phế quản....)" require>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="sot" name="trieuchung_sot" class="radio-trieuchung" value="Sốt ">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="sot" name="trieuchung_sot" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Ho <span class="text-danger">(*)</span></td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="ho" name="trieuchung_ho" class="radio-trieuchung" value="Ho ">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="ho" name="trieuchung_ho" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="dauhong" name="trieuchung_dauhong" class="radio-trieuchung" value="Đau họng">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="dauhong" name="trieuchung_dauhong" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="matViGiac" name="trieuchung_matViGiac" class="radio-trieuchung" value="Mất vị giác">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="matViGiac" name="trieuchung_matViGiac" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="met" name="trieuchung_met" class="radio-trieuchung" value="Mệt">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="met" name="trieuchung_met" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="khotho" name="trieuchung_khotho" class="radio-trieuchung" value="Khó thở">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="khotho" name="trieuchung_khotho" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center td-center">
                                                <input type="radio" id="khac" name="trieuchung_khac" class="radio-trieuchung" value="Triệu chứng khác">
                                            </td>
                                            <td class="text-center td-center">
                                                <input type="radio" id="khac" name="trieuchung_khac" class="radio-trieuchung" value="" checked="">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody id="list-dichte">
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="coMacCoVid" name="dichte_coMacCoVid" class="radio-dichte" value="Đang mắc covid">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="coMacCoVid" name="dichte_coMacCoVid" value="" class="radio-dichte" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="tiepXucGan" name="dichte_tiepXucGan" class="radio-dichte" value="Có tiếp xúc với ca nhiễm">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="tiepXucGan" name="dichte_tiepXucGan" value="" class="radio-dichte" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="diNoiKhac" name="dichte_diNoiKhac" class="radio-dichte" value="Đi tới vùng lãnh thổ khác">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="diNoiKhac" name="dichte_diNoiKhac" value="" class="radio-dichte" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="cachlyTapTrung" name="dichte_cachlyTapTrung" class="radio-dichte" value="Cách ly tập trung">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="cachlyTapTrung" value="" name="dichte_cachlyTapTrung" class="radio-dichte" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="dauhieu" name="dichte_dauhieu" class="radio-dichte" value="Có người thân bị covid">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="dauhieu" name="dichte_dauhieu" value="" class="radio-dichte" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center td-center">
                                                    <input type="radio" id="dieuTri" name="dichte_dieuTri" class="radio-dichte" value="Có điều trị covid">
                                                </td>
                                                <td class="text-center td-center">
                                                    <input type="radio" id="dieuTri" name="dichte_dieuTri" class="radio-dichte" value="" checked="">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <div class="row">
                <div class="col-12 my-3 text-center">
                    <div class="btn-group w-50"><button type="submit" name="btnsave" class="btn btn-primary width-sm ml-1">Gửi</button></div>
                </div>
            </div>
        </div>
    </div>
