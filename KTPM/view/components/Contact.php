	...
	<div class="container">
		...
		<form class="contact-form mt-5" method="POST">
          ...
          <div class="col-12 py-2 wow fadeInUp">
			...
			<input type="submit" class="btn btn-primary wow zoomIn" name="question" id="nut" value="Để lại câu hỏi mới" />
			...
			if (isset($_POST['question'])) {
				$resultAddQuestion = addQuestion($_POST['newmessage'], $_SESSION['id']);
				echo '<script>alert("' . $resultAddQuestion . '");</script>';
			}
